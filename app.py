...
def tela_login():
    ...
    with col2:
        ...
        with col_f1:
            st.link_button("🫂 Visitante", "https://docs.google.com/forms/d/e/1FAIpQLScuFOyVP1p0apBrBc0yuOak2AnznpbVemts5JIDe0bawIQIqw/viewform?usp=header", use_container_width=True)
            st.link_button("🙏 Oração", "https://docs.google.com/forms/d/e/1FAIpQLSe8W9x1Q9AwlSXytO3NDFvi2SgMKpfC6ICTVhMVH92S48KyyQ/viewform?usp=header", use_container_width=True)
        with col_f2:
            st.link_button("📌 Recados", "https://docs.google.com/forms/d/e/1FAIpQLSfzuRLtsOTWWThzqFelTAkAwIULiufRmLPMc3BctfEDODY-1w/viewform?usp=header", use_container_width=True)
            st.link_button("🎂 Parabéns", "https://docs.google.com/forms/d/e/1FAIpQLSdI4ConKeN9T1iKFHTgtO89f71vMXdjrbmdbb20zGK0nMUDtw/viewform?usp=header", use_container_width=True)
...
if selected == "Recados":
    mostrar_tabela_gestao(
        "cadastro_recados", 
        "📌 Recados do Dia", 
        link_forms="https://docs.google.com/forms/d/e/1FAIpQLSfzuRLtsOTWWThzqFelTAkAwIULiufRmLPMc3BctfEDODY-1w/viewform?usp=header", 
        filtrar_hoje=True
    )
